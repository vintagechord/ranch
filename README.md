...
관리자 페이지에서 프로젝트 제안, PPP 발매 목록, 이별의 도수를 포함한 참여 파트와 신청, 저금통과 채팅방 링크를 관리할 수 있습니다. 새 UP NEXT 항목을 만든 뒤 대표 이미지를 업로드하고 아트워크·소개글·뮤직비디오 등의 파트를 열 수 있으며, 발매 완료 시 상태와 YouTube 영상 ID를 수정해 RELEASED 목록으로 이동할 수 있습니다.
