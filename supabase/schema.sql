...
with inserted_release as (
  ...
  cross join (
    values
      ('composition'::text, 'filled'::text, 1::smallint, 10),
      ('lyrics'::text, 'open'::text, 5::smallint, 20),
      ('arrangement'::text, 'open'::text, 5::smallint, 30),
      ('planning'::text, 'open'::text, 5::smallint, 40),
      ('a_and_r'::text, 'open'::text, 5::smallint, 50),
      ('artwork'::text, 'open'::text, 5::smallint, 60),
      ('video'::text, 'open'::text, 5::smallint, 70),
      ('vocal'::text, 'open'::text, 5::smallint, 80),
      ('mixing'::text, 'open'::text, 5::smallint, 90),
      ('mastering'::text, 'open'::text, 5::smallint, 100)
  ) as desired_role(role_type_code, state, capacity, sort_order)
